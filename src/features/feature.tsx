...
const Feature = () => {
  ...
  useEffect(() => {
    ...
    // Set data-theme
    document.documentElement.setAttribute('data-theme', themeMap[dataTheme] || '');
    // Set data-layout
    document.documentElement.setAttribute('data-layout', layoutMap[dataLayout] || '');
    // Set data-sidebar
    document.documentElement.setAttribute('data-sidebar', sidebarMap[dataSidebar] || '');
    // Set data-sidebarbg (was data-sidebar-bg)
    document.documentElement.setAttribute('data-sidebarbg', sidebarBgMap[dataSidebarBg] || '');
    // Set data-color
    document.documentElement.setAttribute('data-color', colorMap[dataColor] || '');
    // Set data-topbar
    document.documentElement.setAttribute('data-topbar', topBarMap[dataTopBar] || '');
  ...
  useEffect(() => {
    ...
    document.body.setAttribute('data-sidebarbg', sidebarBgMap[dataSidebarBg] || '');
